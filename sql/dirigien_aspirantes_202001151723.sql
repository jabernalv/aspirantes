...
--
-- Servidor: localhost
-- Tiempo de generación: 15-01-2020 a las 22:22:48
...
('dc61d3aa-37cf-11ea-ad3a-752a74c57f2e', 'a2818388-37cf-11ea-ad3a-752a74c57f2e', 1, 'No se puede cambiar.', '/archivos/aspirantes/793/79365371/79365371_er8uxlmZwpHaZe-whiaNWN9iRCAbdLEM', 'fc81ea7cfb2bc2217d0fbe8c8c0ea445', '2020-01-15 19:47:28', '2020-01-15 19:47:28');
...
CREATE TABLE `aspirante` (
  ...
  `celular` varchar(30) NOT NULL COMMENT 'Número de celular',
  ...
  `delete_token` varchar(128) DEFAULT NULL COMMENT 'Token de borrado',
...
INSERT INTO `aspirante` (`uuid`, `nombres`, `apellidos`, `correo_electronico`, `password_hash`, `fecha_nacimiento`, `tipo_identificacion_id`, `identificacion`, `celular`, `urlfoto`, `status`, `verification_token`, `delete_token`, `password_reset_token`, `auth_key`, `ip_creacion`, `created_at`, `updated_at`) VALUES
('a2818388-37cf-11ea-ad3a-752a74c57f2e', 'JAIRO ABRAHAM', 'BERNAL VILLANUEVA', 'jabernal@gmail.com', '$2y$13$XuJRfNC2249zhtJX3bSJ3eKKeWzcQGF8vfW79PfUXm0TjPWF3jiq6', '1965-07-28', 1, '79365371', '3138963203', '/archivos/aspirantes/793/79365371/79365371_9rctLcxqcLOhyhmslK7KSo_jvlq1XBB3.png', 10, NULL, NULL, NULL, '0i8_jxIAhg5XX3MKMln9vaKY-HFI9z6b', '::1', '2020-01-15 19:47:24', '2020-01-15 19:48:42'),
('b37a615c-37cd-11ea-ad3a-752a74c57f2e', 'JAIRO ABRAHAM', 'BERNAL VILLANUEVA', 'jabernal@gmail.com5e1f6b36d2160', '$2y$13$Hw4IdGd50eJxboBjtBIK/.pNJGOI67phljk/9asD9tS/MWZhbyTHG', '1965-07-28', 1, '7936537155e1f6b36d2166', '31389632035e1f6b36d2167', '/archivos/aspirantes/793/79365371/79365371_x78EfGLse87A2zvVdCC8N7j14GOWkQxL.png', 0, NULL, NULL, NULL, '', '::1', '2020-01-15 19:39:08', '2020-01-15 19:43:28');
...
CREATE TABLE `tipo_identificacion` (
  ...
  `abreviatura` varchar(3) NOT NULL COMMENT 'Abreviatura',
  `activo` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Activo o no'
...
INSERT INTO `tipo_identificacion` (`id`, `nombre`, `abreviatura`, `activo`) VALUES
...
(31, '::1', '::1', '3138963203', 'jabernal@gmail.com', '79365371', 457971, '2020-01-15 18:23:37', '2020-01-15 19:39:13', 1),
(32, '::1', '::1', '3138963203', 'jabernal@gmail.com', '79365371', 636337, '2020-01-15 19:46:41', '2020-01-15 19:47:28', 1);
...
--
ALTER TABLE `opcion_cargo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador', AUTO_INCREMENT=51;
