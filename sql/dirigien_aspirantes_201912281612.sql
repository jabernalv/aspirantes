...
--
-- Servidor: localhost
-- Tiempo de generación: 28-12-2019 a las 21:11:28
...
('7937b320-1edf-11ea-8824-61b35fc2af27', 'Jairo Abraham', 'Bernal Villanueva', 'jabernal@gmail.com', '$2y$13$oYEKfwxRGdC/21x/dN/VYO/ajtDkpiViJakc7nJDTciUvPGbB9s6.', '1965-07-28', 1, '79365371', 10, 'B3TsUdByMDLWfOPG5zBlDVA_z-7G--oj_1576375633', NULL, 'yjLhaBIzwGftyEgs5Hf-2Dp81taJVqF9', '::1', '2019-12-15 02:07:13', '2019-12-26 02:39:10');
...
--
-- Volcado de datos para la tabla `aspirante_cargo`
--

INSERT INTO `aspirante_cargo` (`uuid`, `aspirante_uuid`, `cargo_id`, `opcion_cargo_id`, `pin_proceso_uuid`, `estado_id`, `created_at`, `modified_at`) VALUES
('b21bdf40-291b-11ea-9e82-4aedc9276790', '7937b320-1edf-11ea-8824-61b35fc2af27', 3, 6, '12356ebc-2905-11ea-8937-dd6870f88cd5', 1, '2019-12-28 02:43:09', '2019-12-28 02:43:09');
...
(5, 1, 'Cargo 5', '2019-12-17 02:28:36', '2019-12-18 02:20:28');
...
('12364f58-2905-11ea-8937-dd6870f88cd5', 1, '12364f6c-2905-11ea-8937-dd6870f88cd5', 0, '2019-12-28 00:00:34', '2019-12-28 00:00:34'),
('12373648-2905-11ea-8937-dd6870f88cd5', 1, '1237365c-2905-11ea-8937-dd6870f88cd5', 0, '2019-12-28 00:00:34', '2019-12-28 00:00:34'),
...
(1, 1, 'Proceso 1', '2019-12-06', '2020-01-31', 1, 1, '2019-12-01 15:00:15', '2019-12-28 00:12:35');
...
CREATE TABLE `soporte` (
  ...
  `archivo_ruta_web` varchar(64) NOT NULL COMMENT 'Ruta del archivo',
...
INSERT INTO `soporte` (`uuid`, `aspirante_uuid`, `tipo_soporte_id`, `comentarios_aspirante`, `archivo_ruta_web`, `md5`, `created_at`, `modified_at`) VALUES
('0184b66c-28f7-11ea-8937-dd6870f88cd5', '7937b320-1edf-11ea-8824-61b35fc2af27', 2, 'Experiencia 001', '/793/79365371/79365371_x_TQz7Lv0riSO6S76j_bYd6z_A1tdg58', '91c6ffa0ac1f7cecf4747ea6d4a6c038', '2019-12-27 22:19:54', '2019-12-27 22:19:54'),
('6db3deda-2915-11ea-8937-dd6870f88cd5', '7937b320-1edf-11ea-8824-61b35fc2af27', 5, 'Pregrado', '/793/79365371/79365371_Qzw65xcXOa0DT5OED9oLd-g3RfiurcSN', 'f0784351a08fa28e1ec0208433e69f7e', '2019-12-28 01:57:40', '2019-12-28 01:57:40'),
('76e3b256-28f1-11ea-8937-dd6870f88cd5', '7937b320-1edf-11ea-8824-61b35fc2af27', 1, 'Cédula de ciudadanía', '/793/79365371/79365371__4ieNOU4yX4AoHzY8GPkslEmGFGWXPcg', 'd167b53918041819c98484a9f3155aa9', '2019-12-27 21:40:13', '2019-12-27 23:15:18'),
('e97b60d6-28fe-11ea-8937-dd6870f88cd5', '7937b320-1edf-11ea-8824-61b35fc2af27', 2, 'Experiencia demostrada', '/793/79365371/79365371_e4_UcbxqnTev-jjC0JrXi2b31V--vYIB', '47e219a1ab9828a8ca0728c12cd5cbb8', '2019-12-27 23:16:29', '2019-12-27 23:16:29');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `soporte_cargo`
--

DROP TABLE IF EXISTS `soporte_cargo`;
CREATE TABLE `soporte_cargo` (
  `uuid` char(36) NOT NULL COMMENT 'Identificador',
...
--
-- Volcado de datos para la tabla `soporte_cargo`
--

INSERT INTO `soporte_cargo` (`uuid`, `soporte_uuid`, `aspirante_cargo_uuid`, `comentarios_aspirante`, `comentarios_analista`, `tenido_en_cuenta`) VALUES
('c8d82c02-291b-11ea-9e82-4aedc9276790', 'e97b60d6-28fe-11ea-8937-dd6870f88cd5', 'b21bdf40-291b-11ea-9e82-4aedc9276790', 'Experiencia demostrada', NULL, 0);
...
--
-- Indices de la tabla `soporte_cargo`
--
ALTER TABLE `soporte_cargo`
  ADD PRIMARY KEY (`uuid`),
  ADD UNIQUE KEY `UQ_SOPORTEPROCESO_SOPORTE_ASPIRANTECARGO` (`soporte_uuid`,`aspirante_cargo_uuid`) USING BTREE,
  ADD KEY `IX_SOPORTEPROCESO_SOPORTE` (`soporte_uuid`),
  ADD KEY `IX_SOPORTEPROCESO_PROCESO_TENIDOENCUENTA` (`aspirante_cargo_uuid`,`soporte_uuid`,`tenido_en_cuenta`),
...
--
-- Filtros para la tabla `soporte_cargo`
--
ALTER TABLE `soporte_cargo`
  ...
  ADD CONSTRAINT `FK_SOPORTEPROCESO_SOPORTE` FOREIGN KEY (`soporte_uuid`) REFERENCES `soporte` (`uuid`) ON UPDATE CASCADE;
COMMIT;
