...
<div class="stepwizard">
    <div class="stepwizard-row setup-panel">
        <div class="stepwizard-step">
            <a href="#step-1" type="button" class="btn btn-primary btn-circle"><i class="fa fa-envelope"></i></a>
            <p>Correo</p>
        </div>
        <div class="stepwizard-step disabled">
            <a href="#step-2" type="button" class="btn btn-default btn-circle disabled"><i class="fa fa-mobile-alt"></i></a>
            <p>Autenticación</p>
        </div>
        <div class="stepwizard-step disabled">
            <a href="#step-3" type="button" class="btn btn-default btn-circle disabled"><i class="fa fa-user"></i></a>
            <p>Datos personales</p>
        </div>
        <div class="stepwizard-step disabled">
            <a href="#step-4" type="button" class="btn btn-default btn-circle disabled"><i class="fa fa-camera-retro"></i></a>
            <p>Fotografía</p>
        </div>
        <div class="stepwizard-step disabled">
            <a href="#step-5" type="button" class="btn btn-default btn-circle disabled"><i class="fa fa-id-card"></i></a>
            <p>Documento ID</p>
        </div>
        <div class="stepwizard-step disabled">
            <a href="#step-6" type="button" class="btn btn-default btn-circle disabled"><i class="fa fa-key"></i></a>
            <p>Contraseña</p>
        </div>
        <div class="stepwizard-step disabled">
            <a href="#step-7" type="button" class="btn btn-default btn-circle disabled"><i class="fa fa-check"></i></a>
            <p>Confirmación</p>
        </div>
    </div>
</div>
<section class="row setup-content" id="step-1">
    <div class="col-md-12">
        <fieldset>
                    ...
                    <ul>
                        <li class="helpli noshow" id="help-for-signupform-correo_electronico">
                            ...
                            <ul>
                                ...
                                <li>Si sale el error <span style="color:#ce0606 !important">Correo electrónico ya registrado pero sin verificar.</span>, quiere decir que ya se hizo un registro con ese buzón de correo pero no se ha realizado la verificación, busque en su buzón el correo de verificación o <?= Html::a("solicite que se le envíe de nuevo", Url::to(['/site/resend-verification-email'])) ?>.</li>
                                <li>Si sale el error <span style="color:#ce0606 !important">Correo electrónico ya registrado y verificado.</span>, quiere decir que ya se hizo un registro con ese buzón de correo, <?= Html::a("ingrese al sistema", Url::to(['/site/logi'])) ?> usando el correo y contraseña registrados. Si ha olvidado la contraseña puede <?= Html::a("recuperarla aquí", Url::to(['/site/requests-password-reset'])) ?>.</li>
                                <li>Si sale el error <span style="color:#ce0606 !important">Correo electrónico no permitido.</span>, quiere decir que está intentando el registro con un buzón de correo falso o de un dominio bloqueado, debe cambiar el correo.</li>
                                <li>El correo electrónico funciona como usuario del sistema y por lo tanto NO podrá ser cambiado más adelante, use un correo personal al cual pueda acceder siempre.</li>
                            </ul>
                        </li>
                        <li class="helpli noshow" id="help-for-signupform-repite_correo_electronico">Repita el correo electrónico que ingresó en el campo anterior, debe coincidir por completo.</li>
                        <li class="helpli noshow" id="help-for-signupform-captcha">Ingrese el texto que se ve en la imagen. Si le parece muy complicada la imagen puede dar clic sobre ella para cambiar el texto que se muestra.</li>
                    </ul>
                </div>
                <div class="col-md">
                    <div class="form-row">
                        <div class="col">
                            <?=
                                    $form->field($model, 'correo_electronico', ['enableAjaxValidation' => true, 'addon' => ['prepend' => ['content' => '<i class="fa fa-envelope"></i>']]])
                                    ->textInput(['type' => 'email', 'maxlength' => true, 'placeholder' => 'Buzón de correo electrónico', 'class' => 'form-control nocopypaste triminput correosaspirante focus', 'title' => 'Ingrese su correo electrónico.'])
                                    ->label(false)
                            ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <?=
                                    $form->field($model, 'repite_correo_electronico', ['addon' => ['prepend' => ['content' => '<i class="fa fa-envelope"></i>']]])
                                    ->textInput(['type' => 'email', 'maxlength' => true, 'placeholder' => 'Repita el buzón de correo electrónico', 'class' => 'form-control nocopypaste triminput correosaspirante', 'title' => 'Ingrese de nuevo el correo electrónico.', 'data-spanid' => 'span_correoelectronico'])
                                    ->label(false)
                            ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <?=
                            $form->field($model, 'captcha', ['enableAjaxValidation' => true])->widget(Captcha::class, [
                                'template' => '<div class="col-xs-12">{image}</div><div class="input-group"><div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-code"></i></span></div>{input}</div>',
                                'options' => ['placeholder' => 'Ingrese el texto que se ve en la imagen', 'class' => 'form-control']
                            ])->label(false);
                            ?>
                        </div>
                    </div>
            ...
            <div class="form-row">
                <div class="col-md">
                    <button class="btn btn-primary nextBtn float-right" type="button">Siguiente <i class="fa fa-angle-double-right"></i></button>
                </div>
            </div>
        </fieldset>
    </div>
    ...
    <div class="col-md-12">
        <fieldset>
            ...
            <div class="form-row">
                <div class="col-md-8">
                    <ul>
                        <li class="helpli noshow" id="help-for-signupform-tipo_identificacion_select2">Seleccione el tipo de identificación.</li>
                        <li class="helpli noshow" id="help-for-signupform-identificacion">
                            ...
                            <ul>
                                ...
                                <li>Solo se permite que se registre una vez por cada documento de identificación.</li>
                                <li>Debe ser el mismo que aparece en el archivo .pdf que se solicitará en el paso 4, esto será verificado antes de autorizar el ingreso al sistema.</li>
                                <li>Si sale el error <span style="color:#ce0606 !important">Identificación ya registrada y verificada.</span>, quiere decir que ya se hizo un registro con ese número de identificación y se realizó la verificación correspondiente, <?= Html::a("ingrese al sistema", Url::to(['/site/logi'])) ?> usando el correo y contraseña registrados. Si ha olvidado la contraseña puede <?= Html::a("recuperarla aquí", Url::to(['/site/requests-password-reset'])) ?>.</li>
                            </ul>
                        </li>
                        <li class="helpli noshow" id="help-for-signupform-celular">
                            Ingrese el celular que usará para validar el registro.
                            <ul>
                                <li>Recibirá un Token en mensaje de texto para validar que el celular existe. Solo se permiten números de celular de Colombia.</li>
                                <li>El mismo número de celular solo se puede utilizar para registrar dos personas diferentes.</li>
                                <li>Si sale el error <span style="color:#ce0606 !important"># celular ya usado.</span>, quiere decir que ya se realizaron dos registros con ese número de celular, debe usar otro número de celular.</li>
                                <li>No podrá ser cambiado más adelante, use un número de celular personal al cual pueda acceder siempre.</li>
                            </ul>
                        </li>
                        <li class="helpli noshow" id="help-for-obtener-token-button">
                            Cuando haya diligenciado todos los datos anteriores se habilitará el botón Token. Dé clic en el botón para recibir el Token en mensaje de texto.
                        </li>
                ...
                <div class="col-md">
                    <div class="form-row">
                        <div class="col">
                            <?=
                                    $form
                                    ->field($model, 'tipo_identificacion_id', ['addon' => ['prepend' => ['content' => '<i class="fa fa-id-badge"></i>']]])
                    ...
                    <div class="form-row">
                        <div class="col">
                            <?=
                                    $form->field($model, 'identificacion', ['enableAjaxValidation' => true, 'addon' => ['prepend' => ['content' => '<i class="fa fa-id-card"></i>']]])
                    ...
                    <div class="form-row">
                        <div class="col">
                            <?=
                                    $form->field($model, 'celular', ['enableAjaxValidation' => true, 'addon' => ['prepend' => ['content' => '<i class="fa fa-phone"></i>']]])
                    ...
                    <div class="form-row">
                        <div class="col">
                            <?= Html::button('<i class="fa fa-mobile-alt"></i> Token', ['class' => 'btn btn-primary', 'id' => 'obtener-token-button', 'disabled' => 'disabled']) ?>
                        </div>
                        <div class="col-md-8">
                            <?=
                                    $form->field($model, 'token', ['enableAjaxValidation' => true, 'addon' => ['prepend' => ['content' => '<i class="fa fa-sticky-note"></i>']]])
            ...
            <div class="form-row">
                <div class="col-md">
                    <button class="btn btn-secondary prevBtn float-left" type="button" tabindex="-1"><i class="fa fa-angle-double-left"></i> Anterior</button>
                    <button class="btn btn-primary nextBtn float-right" type="button">Siguiente <i class="fa fa-angle-double-right"></i></button>
                </div>
            </div>
        </fieldset>
                ...
                <div class="col-md-8">
                    <ul>
                        <li class="helpli noshow" id="help-for-signupform-nombres">
                            ...
                            <ul>
                                <li>Tenga presente que esta información se validará contra el documento .pdf que cargue.</li>
                                <li>No podrá ser cambiado más adelante.</li>
                            </ul>
                        </li>
                        ...
                        <li class="helpli noshow" id="help-for-signupform-fecha_nacimiento">
                            Ingrese la fecha de nacimiento en formato AAAA-MM-DD, tal y como aparece en el documento de identidad.
                            <ul>
                                <li>Tenga presente que esta información se validará contra el documento .pdf que cargue.</li>
                                <li>No podrá ser cambiado más adelante.</li>
                            </ul>
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            /* echo $form->field($model, 'fecha_nacimiento')->widget(DatePicker::class, [
                              ...
                              'data-spanid' => 'span_fechanacimiento',
                              //'autocomplete' => 'off'
                              ],
        ...
        <fieldset>
            ...
            <div class="form-row">
                <div class="col-md-8">
                    ...
                    <ul>
                        ...
                        <li class="helpli noshow" id="help-for-foto-button">
                            ...
                            <ul>
                                <li>Si tiene varias cámaras debe seleccionar la que va a usar para tomar su fotografía.</li>
                                <li>La fotografía se validará contra el documento .pdf que cargue para garantizar que la persona que se registra es la propietaria del documento de identidad.</li>
                                <li>No podrá ser cambiada más adelante. Puede tomarla varias veces hasta que esté satisfecho con el resultado.</li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="col-md">
                    ...
                    <div class="form-row">
                        <div class="col">
                            <select name="listaDeDispositivos" id="listaDeDispositivos" style="font-size: x-small;" tabindex="-1"></select>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <?php echo Html::button('<i class="fa fa-camera-retro"></i> Tomar foto', ['id' => "foto-button", 'class' => "btn btn-primary focus"]) ?><br>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
            ...
            <div class="form-row">
                    ...
                    <ul>
                        <li class="helpli noshow" id="help-for-documentoidentificacion-button">
                            ...
                            <ul>
                                ...
                                <li>Asegúrese que puede ver en la parte inferior de manera correcta el archivo antes de dar clic en [Siguiente].</li>
                ...
                <div class="col-md">
                    <div class="form-row">
                        <div class="col">
                            <?php
                            echo Html::button("<i class='fa fa-id-card'></i> Documento ID", ['class' => 'btn btn-primary focus', 'id' => 'documentoidentificacion-button']);
                            ?>
                            <br><br>
                        </div>
                        <div class="col">
                ...
                <div class="col-md-8">
                    <ul>
                        <li class="helpli noshow" id="help-for-signupform-password_fake">
                            ...
                            <ul>
                                <li>La contraseña debe ser de 8 caracteres de largo o más y contener por lo menos 1 letra mayúscula, 1 letra minúscula, 1 número y 1 caracter especial como estos ($*#@!).</li>
                            </ul>
                        </li>
...
<section class="row setup-content" id="step-7">
    <div class="col-md-12">
        <fieldset>
            ...
            <div class="form-row">Tenga en cuenta que una vez enviado el formulario no podrá cambiar los siguientes datos:</div>
            <div class="form-row">
                <div class="col">
                    <ul>
                        <li><strong>Nombres:</strong> <span id="span_nombres"></span></li>
                        <li><strong>Apellidos:</strong> <span id="span_apellidos"></span></li>
                        <li><strong>Correo electrónico:</strong> <span id="span_correoelectronico"></span></li>
                        <li><strong>Fotografía.</strong></li>
                    </ul>
                </div>
                <div class="col">
                    <ul>
                        <li><strong>Fecha de nacimiento:</strong> <span id="span_fechanacimiento"></span></li>
                        <li><strong>Documento de identificación:</strong> <span id="span_tipodocumentoidentificacion"></span> <span id="span_documentoidentificacion"></span></li>
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <div id="errorpdf" class="form-row"><div class='alert-danger alert alert-dismissible' role='alert'>Debe cargar el archivo de documento de identificación.</div></div>
                    <div class="form-row embed-container"><iframe id="viewerpdfconfirm" frameborder="0" scrolling="no" width="400" height="600" allowfullscreen></iframe></div>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    Al enviar la información usted acepta los términos y condiciones.<br>¿Está por completo seguro de que desea enviar el formulario?
                </div>
                <div class="col">
            ...
            <div class="form-row">
                <div class="col-md">
                    <button class="btn btn-secondary prevBtn float-left" type="button" tabindex="-1"><i class="fa fa-angle-double-left"></i> Anterior</button>
                    <?= Html::submitButton('<i class="fa fa-user-check"></i> Registro', ['class' => 'btn btn-custom btn-light nextBtn btn-block  float-right', 'name' => 'signup-button', 'id' => 'signup-button']) ?>
                </div>
            </div>
        </fieldset>
    </div>
...
$("#signupform-password_fake,#signupform-password_repeat_fake").on("blur", function(event){
    var len = $(this).attr("id").length - 5, fid = $(this).attr("id").slice(0, len), eid = "#signupform-enc_"  + fid.slice(11), encrypt = new JSEncrypt();
                    encrypt.setPublicKey(pk);
                    var encrypted = encrypt.encrypt("#" + $(fid).val());
        $(eid).val(encrypted);
