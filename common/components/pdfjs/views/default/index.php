...
<div id="outerContainer">
            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer">
                  ...
                  <select id="scaleSelect" title="Zoom" tabindex="23" data-l10n-id="zoom">
                    ...
                    <option id="pageFitOption" title="" value="page-fit" data-l10n-id="page_scale_fit">Ajuste de página</option>
                    <option id="pageWidthOption" title="" value="page-width"
                            data-l10n-id="page_scale_width">Ancho de página</option>
    ...
    <div id="dialogContainer">
        <dialog id="passwordDialog">
            <div class="row">
                <label for="password" id="passwordText" data-l10n-id="password_label">Ingrese la contraseña para abrir
                    este archivo PDF:</label>
            </div>
            <div class="row">
